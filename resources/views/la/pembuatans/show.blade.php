...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $pembuatan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Pembuatans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/pembuatans/'.$pembuatan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Pembuatans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.pembuatans.destroy', $pembuatan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/pembuatans') }}" data-toggle="tooltip" data-placement="right" title="Back to Pembuatans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'tanggalproduksi')
						@la_display($module, 'KodeProduk')
						@la_display($module, 'JumlahProduksi')
					</div>
				</div>
			</div>
		</div>
