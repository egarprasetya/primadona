...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $harga->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Hargas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/hargas/'.$harga->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Hargas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.hargas.destroy', $harga->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/hargas') }}" data-toggle="tooltip" data-placement="right" title="Back to Hargas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'StatusHarga')
						@la_display($module, 'Harga')
						@la_display($module, 'TanggalHarga')
