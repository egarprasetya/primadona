...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $transaksipenjualan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("TransaksiPenjualans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/transaksipenjualans/'.$transaksipenjualan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("TransaksiPenjualans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.transaksipenjualans.destroy', $transaksipenjualan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/transaksipenjualans') }}" data-toggle="tooltip" data-placement="right" title="Back to TransaksiPenjualans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'NoPembeli')
						@la_display($module, 'TanggalTransaksi')
						@la_display($module, 'JumlahBarangBeli')
						@la_display($module, 'KodeProduk')
						@la_display($module, 'KodeCabang')
					</div>
				</div>
			</div>
		</div>
