...
class CreateCabangsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Cabangs", 'cabangs', 'NamaCabang', 'fa-cube', [
            ["NamaCabang", "Nama Cabang", "String", false, "", 1, 50, false],
            ["KodeProduk", "Nama Produk", "Dropdown", false, "", 0, 0, false, "@produks"],
        ]);
