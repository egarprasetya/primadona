...
class CreateProduksTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Produks", 'produks', 'NamaProduk', 'fa-briefcase', [
            ["NamaProduk", "Nama Produk", "String", false, "", 1, 19, false],
            ["UkuranProduk", "Ukuran Produk", "String", false, "", 1, 20, false],
        ]);
