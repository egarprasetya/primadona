...
class CreateBahansTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Bahans", 'bahans', 'NamaBahanBaku', 'fa-cube', [
            ["NamaBahanBaku", "Nama Bahan Baku", "String", false, "20", 0, 256, false],
            ["HargaBahanBaku", "Harga Bahan Baku", "Integer", false, "11", 0, 11, false],
        ]);
